...
struct Student
{
    ...
    bool operator<(const Student b) const { return score > b.score; }
};
bool cmp(Student a, Student b) { return (a.rank == b.rank) ? a.id < b.id : a.rank < b.rank; }
